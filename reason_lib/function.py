...
from reason_lib.utils import Salesforce_Pair, Formatter
...
def post_processing(*args, **context):
    ...
    salesforce_reason_df.to_csv(pj(CACHEPATH, 'formatted_merged_reasons.csv'))

def generate_pairs():
    dataloader = Salesforce_Pair(features_mappings['salesforce_pair'])
    ...
    return dataloader.cache_reason_df
